                        ...
                        <div className="col-12">
                            ...
                            <div className="EmberlineStudios">
                                <a href="/" aria-label="EmberlineStudios">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 263.21 205" style={{enableBackground:'new 0 0 263.21 205'}}>
                                        <g className="ESlogo">
                                            <g>
