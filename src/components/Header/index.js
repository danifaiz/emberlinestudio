                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-auto mw_bg">
                                <nav className="es_menu-l">
                                    <ul>
                                        <li><a href="index.html" className="inver">Home</a></li>
                                        <li><a href="projects.html" className="inver">Projects</a></li>
                                        <li><a href="services.html" className="inver">Services</a></li>
                                        <li><a href="about-us.html" className="inver">About Us</a></li>
                                        <li><a href="contact-us.html" className="inver">Contact Us</a></li>
                                    </ul>
                                </nav>
                            </div>
