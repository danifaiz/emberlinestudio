...
export default class Projects extends Component {
  ...
  componentDidMount() {
    ...
    if (cachedTags) {
      ...
      axios
        .get(`${PATHS.BASE_URL}` + `${PATHS.TAGS_URL}`)
        .then((res) => {
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 text-center">
                ...
                <p className="mb-0">
                  We provide our clients a wide range of design services with a
                  promise of excellence and ingenuity.
                </p>
              </div>
            </div>
          </div>
                  ...
                  {projects &&
                    projects.map((project) => (
                      <div
                        key={project.id}
                        className={
                          "col-lg-4 col-md-6 col-sm-6 col-12 all " +
                          project.categories
