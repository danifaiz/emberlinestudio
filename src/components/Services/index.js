          ...
          <div className="container">
            <div className="row">
              <div className="col-12 text-center">
                ...
                <p className="mb-0">
                  We are a team, of multi-talented designers, with a passion for
                  creativity and good design. We facilitate companies with our
                  extensive range of design services including architecture &
                  interiors, amusement park designs, retail kiosks &
                  exhibitions, branding & graphics, UI/UX of digital products,
                  3D integrated designs and animations.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="ES-section _Projects pt-0">
          <div className="container">
            <div className="row">
              <Tilt
                options={tiltOptions}
                className="col-xs-12 col-sm-6 col-md-6 col-lg-4 _service js-tilt"
              >
